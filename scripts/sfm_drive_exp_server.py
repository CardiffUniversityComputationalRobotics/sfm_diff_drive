...
class SocialForceModelDriveAction(object):
    ...
    def __init__(self):
        ...
        # PID for rotation
        self.pid_rotation = PID(0.15, 0.1, 0.0001, setpoint=0)
        self.pid_rotation.output_limits = (-0.5, 0.5)
        ...
        #! publishers
        self.velocity_pub = rospy.Publisher("/raw_cmd_vel", Twist, queue_size=10)
    ...
    def execute_cb(self, goal):
        ...
        while not self.check_goal_reached():
            ...
            # print("complete forces:", complete_force)
    ...
    def agents_state_callback(self, data):
        self.agents_states_register = data.people
    ...
    def desired_force(self):
        ...
        # print(norm_desired_direction)
        # print(self.robot_max_vel)
        # print(self.robot_current_vel)
    ...
    def social_force(self):
        ...
        for i in self.agents_states_register:
            ...
            diff_vel = self.robot_current_vel
